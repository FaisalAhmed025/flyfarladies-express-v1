...
var updateUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, imageUrl, _req$body3, email, password, phone, userType, dob, gender, isactive, profession, nationality, nid, passportNumber, passportExpireDate, facebookId, whatsApp, linkedIn, result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          console.log(id);
          _req$body3 = req.body, email = _req$body3.email, password = _req$body3.password, phone = _req$body3.phone, userType = _req$body3.userType, dob = _req$body3.dob, gender = _req$body3.gender, isactive = _req$body3.isactive, profession = _req$body3.profession, nationality = _req$body3.nationality, nid = _req$body3.nid, passportNumber = _req$body3.passportNumber, passportExpireDate = _req$body3.passportExpireDate, facebookId = _req$body3.facebookId, whatsApp = _req$body3.whatsApp, linkedIn = _req$body3.linkedIn;
          _context3.next = 7;
          return _db["default"].query('UPDATE user SET email = ?, password = ?, phone = ?, userType = ?, dob = ?, gender = ?, isactive = ?, profession = ?, national = ?, nid = ?, passportNumber = ?, passportExpireDate = ?, facebookId = ?, whatsApp = ?, linkedIn = ?, profilePhoto =? WHERE id = ?', [email, password, phone, userType, dob, gender, isactive, profession, nationality, nid, passportNumber, passportExpireDate, facebookId, whatsApp, linkedIn, imageUrl, id]);
        case 7:
...
var userdashBoard = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, userQuery, _yield$pool$query7, _yield$pool$query8, result;
...
var addtravler = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req) {
    var userid, travelers, results, _iterator, _step, traveler, partnerId, first_name, last_name, gender, dob, nationality, passport_number, passport_ex_date, email, phone, pax_type, query, values, _yield$pool$query9, _yield$pool$query10, result;
...
var updateTraveler = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var partnerId, image, _req$body4, first_name, last_name, gender, dob, nationality, passport_number, passport_ex_date, email, phone, pax_type, query, values, _yield$pool$query11, _yield$pool$query12, results;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _req$body4 = req.body, first_name = _req$body4.first_name, last_name = _req$body4.last_name, gender = _req$body4.gender, dob = _req$body4.dob, nationality = _req$body4.nationality, passport_number = _req$body4.passport_number, passport_ex_date = _req$body4.passport_ex_date, email = _req$body4.email, phone = _req$body4.phone, pax_type = _req$body4.pax_type;
          query = "\n      UPDATE travel_partners \n      SET \n        first_name = ?,\n        last_name = ?,\n        gender = ?,\n        dob = ?,\n        nationality = ?,\n        passport_copy = ?,\n        passport_number = ?,\n        passport_ex_date = ?,\n        email = ?,\n        phone = ?,\n        pax_type = ?\n      WHERE partnerId = ?\n    ";
          values = [first_name, last_name, gender, dob, nationality, image, passport_number, passport_ex_date, email, phone, pax_type, partnerId];
          console.log(values);
          _context6.next = 9;
          return _db["default"].query(query, values);
        case 9:
...
var myTravelerList = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var userid, query, _yield$pool$query13, _yield$pool$query14, result;
...
var deleteTraveller = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var partnerId, query, _yield$pool$query15, _yield$pool$query16, result;
