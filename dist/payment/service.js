...
var paywithwallet = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var userid, bookingid, bookingquery, _yield$pool$query, _yield$pool$query2, booking, userquery, _yield$pool$query3, _yield$pool$query4, user, totalprice, newWalletBalance, updateuserbalancequery, updatebookingquery, bookingstatus, paymentstatus, value, updatedBooking, depositby, status, ledgervalue, insertledger;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 13:
          console.log(booking[0].bookingStatus);
        ...
        case 22:
          totalprice = booking[0].totalAmount; // Check wallet balance
          if (!(user[0].wallet < totalprice)) {
            _context.next = 25;
            break;
          }
          throw new HttpException('Insufficient balance! please deposit to your wallet', _httpStatus["default"].BAD_REQUEST);
        case 25:
          newWalletBalance = user[0].wallet - totalprice;
          updateuserbalancequery = "UPDATE user SET wallet = ? WHERE uuid = ?";
          _context.next = 29;
          return _db["default"].query(updateuserbalancequery, [userid]);
        case 29:
          updatebookingquery = "UPDATE booking SET bookingStatus = ?, payementStatus = ?, wallet = ?, UpdatedAt = NOW() WHERE Bookingid = ?";
          ...
          value = [_bookingservice.bookingStatus, paymentstatus, user[0].wallet, bookingid];
          _context.next = 36;
          return _db["default"].query(updatebookingquery, value);
        case 36:
          updatedBooking = _context.sent;
