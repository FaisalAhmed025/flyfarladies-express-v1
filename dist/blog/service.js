...
var addBlog = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, Title, Description, Blogfor, WrittenBy, Type, imageUrl, secondurl, query, values;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, Title = _req$body.Title, Description = _req$body.Description, Blogfor = _req$body.Blogfor, WrittenBy = _req$body.WrittenBy, Type = _req$body.Type;
          ...
          values = [Title, Description, Blogfor, WrittenBy, Type, imageUrl, secondurl];
          _context.prev = 5;
          _context.next = 8;
  ...
  return function addBlog(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var getallblogs = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var blogquery, _yield$pool$query, _yield$pool$query2, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          blogquery = "SELECT * from blogs";
          _context2.next = 3;
          return _db["default"].query(blogquery);
        case 3:
...
var getblog = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var blogquery, id, _yield$pool$query3, _yield$pool$query4, data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          id = req.params.id;
          _context3.next = 4;
          return _db["default"].query(blogquery, [id]);
        case 4:
  ...
  return function getblog(_x5, _x6) {
...
var updateBlog = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id, _req$body2, Title, Description, Blogfor, WrittenBy, Type, updateBlockImage, updateQuery, _yield$pool$query5, _yield$pool$query6, data;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          id = req.params.id;
          _req$body2 = req.body, Title = _req$body2.Title, Description = _req$body2.Description, Blogfor = _req$body2.Blogfor, WrittenBy = _req$body2.WrittenBy, Type = _req$body2.Type;
          updateBlockImage = {
            Title: Title,
          ...
          updateQuery = "UPDATE blogs SET ? WHERE id=?";
          _context5.next = 8;
...
var updateBlogImage = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var id, urlid, newImageUrl, _yield$pool$query7, _yield$pool$query8, blog, blogData, blogimages, i, image, _yield$pool$query9, _yield$pool$query10, data;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 11:
          ...
          _context6.next = 17;
          return _db["default"].query('UPDATE blogs SET blogimages = ? WHERE id = ?', [JSON.stringify(blogimages), id]);
        case 17:
        ...
        case 24:
          ...
          console.error('Error updating image URL:', _context6.t0);
  ...
  return function updateBlogImage(_x11, _x12) {
